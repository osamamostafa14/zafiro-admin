...
@section('content')
                        ...
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            <li class="breadcrumb-item">
                                <a class="breadcrumb-link"
                                   href="{{route('branch.order.routes.update')}}">
                                    Orders 
                                </a>
                            </li>
                        ...
                        <div class="col-4">
                            <div class="card">
                                 ...
                                 <div class="card-body">
                                     <div class="media align-items-center"
                                          style="cursor:pointer">
                                         <h6 class="card-header-title pr-3">Drivers:</h6>
                                     </div>
    ...
    <div class="modal fade routes-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
         aria-hidden="true" id="add-note-modal-{{$route->id}}">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <!-- End Modal -->
     ...
     <!-- Modal -->
     <div class="modal fade routes-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
     aria-hidden="true" id="routes-delivered-modal-{{$route->id}}">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                            ...
                            <div class="media align-items-center">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlSelect1">Change Driver<span
                                    ...
                                    <a data-toggle="modal" data-target="#add-note-modal-{{$route->id}}" style="cursor:pointer; color:rgb(5, 5, 5);">Add Note</a>
                                    ...
                                    {{-- <a data-toggle="modal" data-target="#routes-delivered-modal-{{$route->id}}" style="cursor:pointer; color:green;"></a> --}}
                                    @endif
                                </div>
                            </div>
                            <hr>
