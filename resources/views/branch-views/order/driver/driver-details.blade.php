...
</script><script  src="https://maps.googleapis.com/maps/api/js?key={{ config('app.google_map_api_key') }}&libraries=places"></script>
...
var driverId = {{ $driver_id }};
    var url = "{{ route('branch.order.routes.get-driver-live-tracking', ['id' => ':driverId']) }}";
