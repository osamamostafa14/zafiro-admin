        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i> Earniings List</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item"
                                                   href="{{route('admin.earnings.view', [$earning['id']])}}">View</a>
                                            </div>
                                        </div>
                                        <!-- End Dropdown -->
                                    </td>
