    ...
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.notification.specific')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">Notification Topic</label>
                        <input type="text" name="topic" class="form-control" placeholder="Add Topic" required>
                    </div>
                    
                     <div class="form-group">
                        <label class="input-label" for="exampleFormControlInput1">Related Products</label>
                        <input type="text" name="search" class="form-control" placeholder="Products names or tags" required>
                    </div>
