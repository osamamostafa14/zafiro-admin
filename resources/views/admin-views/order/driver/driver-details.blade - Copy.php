        ...
        <div class="row align-items-center">
            <div class="col-sm mb-2 mb-sm-0">
                ...
                <div class="row pt-3 pb-3">
                    ...
                    <!-- <div class="card" style="background-image: url('{{ asset('public/assets/admin/img/chat-icon.png') }}'); background-size: cover; width: 100px">
                  
                        <div class="card-body">
                            <div class="media align-items-center" style="cursor:pointer">
                              
                                <h6 class="card-header-title pr-3"> </h6>
                            </div>
            ...
            <div class="col-sm-auto">
                <a class="btn btn-icon btn-sm btn-ghost-secondary rounded-circle mr-1" href="{{route('admin.message.view',[$driverroutes[0]['driver_id']])}}" 
                data-toggle="tooltip" data-placement="top" title="Call Driver">
                  <i class="fas fa-phone card-icon fa-2x pl-3"></i>
                </a>
                <a class="btn btn-icon btn-sm btn-ghost-secondary rounded-circle" href="" data-toggle="tooltip" data-placement="top" title="Chat with driver">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @for ($i = 0; $i < count($driverroutes); $i++) @php $route=$driverroutes[$i]; @endphp <!-- Modal -->
