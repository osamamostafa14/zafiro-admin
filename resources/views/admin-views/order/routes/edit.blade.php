    ...
    <div class="d-print-none pb-2">
        <div class="row align-items-center">
            ...
            <div class="col-sm-auto">
                <a class="btn btn-icon btn-sm btn-ghost-secondary rounded-circle mr-1" href="{{route('admin.customer.view',[$order['id']-1])}}" data-toggle="tooltip" data-placement="top" title="Previous customer">
                    <i class="tio-arrow-backward"></i>
                </a>
                <a class="btn btn-icon btn-sm btn-ghost-secondary rounded-circle" href="" data-toggle="tooltip" data-placement="top" title="Next Route">
                        ...
                        <div class="modal fade routes-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="add-note-modal-{{$route->id}}">
                            <div class="modal-dialog modal-sm" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{route('admin.order.routes.store-notes', [$route->id])}}" method="post">
                                            @csrf
                    ...
                    <li class="list-inline-item">
                        <div class="col">
                            <div class="row" style="display: flex; align-items: center;">
                                ...
                                <a href="{{ route('admin.order.driver.driver_details', ['driver_id' => $takendriver->id, 'order_id' => $order['id']]) }}"
...
<script>
    ...
    function initMap() {
        ...
        // @foreach($order->order_routes as $myroye)
