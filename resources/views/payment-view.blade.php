            ...
            @elseif(session('payment_method')=='razor_pay')
                ...
                <form action="{!!route('payment-razor')!!}" method="POST">
                    ...
                    <script src="https://checkout.razorpay.com/v1/checkout.js"
                            ...
                            data-name="{{\App\Model\BusinessSetting::where(['key'=>'store_name'])->first()->value}}"
                            data-description="{{$order['id']}}"
                            data-image="{{asset('storage/app/public/store/'.\App\Model\BusinessSetting::where(['key'=>'logo'])->first()->value)}}"
